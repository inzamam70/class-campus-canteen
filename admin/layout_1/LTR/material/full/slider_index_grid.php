					...
					<div class="col-xl-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="slider_create.php" class="btn btn-outline bg-grey border-grey text-grey-600 btn-icon rounded-round border-2 legitRipple" style="color: green;"><i class="icon-plus2"></i></a>
								<a href="#" class="btn btn-outline bg-grey border-grey text-grey-600 btn-icon "style="color: red;"><i class="icon-file-pdf mr-3"></i></a>
